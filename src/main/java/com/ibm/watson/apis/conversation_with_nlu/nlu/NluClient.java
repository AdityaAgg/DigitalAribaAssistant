 ...
 */
package com.ibm.watson.apis.conversation_with_nlu.nlu;
...
public class NluClient {
    ...
    public AnalysisResults query(String userQuery) throws Exception {
        ...
        EntitiesOptions entities = new EntitiesOptions.Builder().model("10:2e6e9741-23d4-4495-9af0-5a1b9dc2e3d6").limit(1).build();
